...
In an R Studio (known to be working with Version 1.2.5001, R 3.5.1) session, install the [shiny](https://github.com/rstudio/shiny) package and run the following commands:
